    ...
    methods
        function obj = streaming_example()
            ...
            PERIOD = 0.1;
             ...
             set(gca,'ylim',[-1.2 1.2])
             obj.ax = ax;
             interactive_plot(obj.h_fig,num2cell(ax));
        ...
        function cb_timer(obj)
            if isvalid(obj.h_fig)
                ...
                if obj.last_t > n_seconds_keep
                    set(obj.ax,'xlim',[obj.last_t - n_seconds_keep, obj.last_t])
                else
                    set(obj.ax,'xlim',[0 n_seconds_keep])
                end
                catch ME
